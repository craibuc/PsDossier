...
# . /PsDossier/PsDossier/Public/Get-DossierBill.ps1
. (Join-Path $PublicPath $sut)

Describe "Get-DossierBill" -Tag 'unit' {
    ...
    BeforeAll {
        ...
        $PSDefaultParameterValues['Get-DossierBill:ServerInstance'] = $Expected.ServerInstance
        $PSDefaultParameterValues['Get-DossierBill:Database'] = $Expected.Database
        $PSDefaultParameterValues['Get-DossierBill:Credential'] = $Expected.Credential   
    }

    Context "Parameter Validation" {
        BeforeAll {
            $Command = Get-Command "Get-DossierBill"
        }
    ...
    Context "By Date" {
        ...
        It "adds a From/To date filter to the WHERE clause" {
            ...
            # act
            Get-DossierBill -FromDate $FromDate -ToDate $ToDate
